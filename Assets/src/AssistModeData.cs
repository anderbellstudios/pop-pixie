  ...
  public static decimal DamageReduction {
    get {
      return System.Convert.ToDecimal(
        ConfigData.Current.Fetch(
          "assist-mode-damage-reduction",
          orSetEqualTo: DEFAULT_DAMAGE_REDUCTION
        )
      );
    }
    set { ConfigData.Current.Set("assist-mode-damage-reduction", value); }
  }
